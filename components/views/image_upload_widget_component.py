...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.preview_image = Image(page, locator=f'{identifier}-image-upload-widget-preview-image', name='Preview image')

        self.image_upload_info_icon = Icon(page, locator=f'{identifier}-image-upload-widget-info-icon', name='Image upload info icon')
        self.image_upload_info_title = Text(page,locator=f'{identifier}-image-upload-widget-info-title-text', name='Image upload info title')
        ...
        self.upload_button = Button(page, locator=f'{identifier}-image-upload-widget-upload-button', name='Upload button')
        self.remove_button = Button(page, locator=f'{identifier}-image-upload-widget-remove-button', name='Remove button')
        self.upload_input = FileInput(page,locator=f'{identifier}-image-upload-widget-input', name='Upload input')

        self.upload_input2 = page.get_by_test_id(f'{identifier}-image-upload-widget-input')
